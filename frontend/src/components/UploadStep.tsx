  ...
  return (
    <section className="panel p-6">
      ...
      <button
        ...
        className="mt-5 flex min-h-10 w-full flex-col items-center justify-center rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 px-5 py-4 transition hover:border-[#C1121F] hover:bg-red-50 focus:outline-none focus:ring-4 focus:ring-red-100"
      >
